...
> `rtauargus.decimals` sera par exemple la valeur utilisée si l'argument
...
Le code source est disponible sur la [plate-forme innovation Insee](https://git.stable.innovation.insee.eu/xkfzv9/rtauargus).
...
Pour tout retour ou signalement d'erreur, utiliser de préférence [ce lien](https://git.stable.innovation.insee.eu/xkfzv9/rtauargus/issues) (ou
éventuellement un
