...
constituant (`micro_asc_rda`, `micro_arb`, `run_tauargus`, `import`). Tout
...
> **[micro_asc_rda()](#fonction-micro_asc_rda) &nbsp;&nbsp;&rarr;&nbsp;&nbsp;
    ...
    [run_tauargus()](#fonction-run_tauargus)   &nbsp;&nbsp;&rarr;&nbsp;&nbsp;
...
la liste de data.frames en sortie de `run_tauargus` (pas de noms définis dans
l'exemple ci-dessus).
...
Le code source est disponible sur la
[plate-forme innovation Insee](https://git.stable.innovation.insee.eu/xkfzv9/rtauargus).
...
[ce lien](https://git.stable.innovation.insee.eu/xkfzv9/rtauargus/issues)
