# Transition from 4 to 3 variables by merging a hierarchical and a non-hierarchical variable

Transition from 4 to 3 variables by merging a hierarchical and a
non-hierarchical variable
...
- v1:
  ...
  non-hierarchical categorical variable
...
- dir_name:
  ...
  directory where to write the hrc files if no folder is specified in
  hrcfiles
