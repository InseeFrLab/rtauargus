...
It applies filtering conditions to a subset of keys and their
...
- criteria:
  ...
  A named list or vector where the names are column names, and the
  values are the totals or values to be used in filtering.
